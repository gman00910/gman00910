...
The dashboard alone has 35+ macro endpoints, earnings scoring engines, real-time breadth analysis, Fed policy tracking, and multi-source sentiment aggregation.
